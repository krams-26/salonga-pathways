        ...
        <div className="container max-w-md">
          <div className="text-center mb-8">
            <Link to="/" className="inline-flex items-center gap-2.5 mb-6">
              <span className="h-12 w-12 rounded-2xl grid place-items-center bg-canopy">
          ...
          <div className="nature-card p-7">
            ...
            <button
              onClick={onGoogle}
              disabled={busy}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-border bg-card hover:bg-secondary transition-smooth text-sm font-medium disabled:opacity-50"
            >
